...
export function AboutSection() {
  ...
  return (
    <section ref={sectionRef} id="about" className="py-20 sm:py-32 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Image Side */}
          <div ref={imageRef} className="relative group animate-slideInLeft" style={{ willChange: 'transform' }}>
            <div className="relative rounded-2xl overflow-hidden h-96 lg:h-full shadow-2xl">
              <img
              ...
              {/* Experience Badge */}
              <div className="absolute bottom-6 right-6 bg-primary text-white rounded-full px-6 py-4 font-bold text-center shadow-2xl">
          ...
          <div ref={contentRef} className="space-y-8 animate-slideInRight" style={{ willChange: 'transform' }}>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={index} className="flex items-center gap-3 group animate-fadeInUp" style={{ animationDelay: `${index * 0.1}s` }}>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              {[
                ...
                <div
                  key={idx}
                  className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl p-4 border border-primary/20 hover:border-primary/50 transition-all duration-300 animate-fadeInUp"
